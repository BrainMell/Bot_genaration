...
func s03Skillup(req *portraitRequest) *gg.Context {
	...
	y := s03Masthead(dc, W, 62, skillTitle, "A STAR BILLING ANNOUNCEMENT", 34)
...
// s03Evolve - class ascension card. Same design language as this style's
...
func s03Evolve(req *portraitRequest) *gg.Context {
	e := *req
	e.DocTitle = "A STAR RECAST"
	if e.SubLabel == "" {
		e.SubLabel = "EVOLVED"
	}
	return s03Skillup(&e)
